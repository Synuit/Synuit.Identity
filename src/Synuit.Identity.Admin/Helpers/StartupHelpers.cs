...
using Synuit.Identity.Admin.ExceptionHandling;
using Synuit.Identity.Admin.Middlewares;
using Synuit.Identity.Admin.Configuration;
using Synuit.Identity.Admin.Configuration.ApplicationParts;
using Synuit.Identity.Admin.Configuration.Constants;
using Synuit.Identity.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Synuit.Identity.Admin.Helpers.Localization;

namespace Synuit.Identity.Admin.Helpers
{
