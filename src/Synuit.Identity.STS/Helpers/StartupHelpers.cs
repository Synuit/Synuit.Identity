...
namespace Synuit.Identity.STS.Helpers
{
   public static class StartupHelpers
   {
          ...
          where TConfigurationDbContext : DbContext, IConfigurationDbContext
      {
         ...
         {
            //$!!$ tac
            options.PublicOrigin = configuration.GetSection(ConfigurationConsts.URL_SECTION_KEY).GetValue<string>(ConfigurationConsts.PUBLIC_ORIGIN_KEY);// ( "https://ids.syid.com";
            //$
