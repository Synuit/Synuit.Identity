...
using Synuit.Identity.Admin.Api.Configuration.ApplicationParts;
using Synuit.Identity.Admin.Api.Configuration.Constants;
using Synuit.Identity.Admin.Api.Helpers.Localization;
using Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Dtos.Identity;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;

namespace Synuit.Identity.Admin.Api.Helpers
{
